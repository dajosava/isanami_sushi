...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/ventas", label: "Ventas", kanji: "売上", icon: Receipt, roles: ["admin", "gerente", "cajero"] },
  ...
  { href: "/inventario/compras", label: "Compras y gastos", kanji: "仕入", icon: ShoppingCart, roles: ["admin", "gerente"] },

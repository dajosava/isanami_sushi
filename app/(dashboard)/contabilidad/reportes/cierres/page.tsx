...
export default async function ReportesCierresDiariosPage() {
  ...
  return (
    <div>
      <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
        <h1 className="font-display text-2xl">Cierres diarios</h1>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {(!cierresDiarios || cierresDiarios.length === 0) && (
          <p className="text-sm text-washi-50">Todavía no hay cierres diarios generados.</p>
        )}
      </div>
    </div>
  );
